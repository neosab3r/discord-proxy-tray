...
| force-proxy (tcp + full builds) | `vendor/force-proxy-tcp.dll`, `vendor/force-proxy-full.dll` (copied to Discord as `force-proxy.dll`) | GPLv3 — `GPL-3.0.txt` | [neosab3r/force-proxy-with-logs](https://github.com/neosab3r/force-proxy-with-logs) (based on [runetfreedom/force-proxy](https://github.com/runetfreedom/force-proxy)) |
...
sidecar binaries. Modified GPL components (force-proxy tcp/full) must keep source
